...
/**
* @brief          Symbolic name for the port DioPort_PORTA.
*/
#define DioConf_DioPort_DioPort_PORTA  ((uint8)0x01U)
/**
* @brief          Symbolic name for the channel DioChannel_STB.
*
*/
#define DioConf_DioChannel_DioChannel_STB  ((uint16)0x0011U)
/* ---------- DioPort_PORTB ---------- */

/**
* @brief          Symbolic name for the port DioPort_PORTB.
*/
#define DioConf_DioPort_DioPort_PORTB  ((uint8)0x02U)
/**
...
*/
#define DioConf_DioPort_DioPort_PORTC  ((uint8)0x05U)
/**
* @brief          Symbolic name for the channel DioChannel_KEYA.
*
*/
#define DioConf_DioChannel_DioChannel_KEYA  ((uint16)0x0054U)
/* ---------- DioPort_BH ---------- */
...
/**
* @brief          Symbolic name for the channel DioChannel_PB20.
*
*/
#define DioConf_DioChannel_DioChannel_PB20  ((uint16)0x0035U)
