...
#define C40_IP_ENABLE_USER_MODE_SUPPORT     (STD_OFF)
        ...
        #error MCAL_ENABLE_USER_MODE_SUPPORT is not enabled. For running Mem in user mode the MCAL_ENABLE_USER_MODE_SUPPORT needs to be defined
    #endif
#endif
...
#define C40_BLOCK4_PIPE_SELECT              (0x04U)
#endif


/*! Enable development error check */
#define C40_IP_DEV_ASSERT(x)                (void)(x)
#define C40_SECTOR_SET_LOCK_API             (STD_OFF)
...
#define C40_ECC_CHECK_BY_AUTOSAR_OS         (STD_OFF)
    ...
    #define C40_ECC_VALUE                   (0xFFFFFFFFU)
#endif
...
#define C40_ASYNC_WRITE_TIMEOUT             (0U)

#define C40_ASYNC_ERASE_TIMEOUT             (0U)

#define C40_SYNC_WRITE_TIMEOUT              (0U)

#define C40_SYNC_ERASE_TIMEOUT              (0U)

#define C40_ABORT_TIMEOUT                   (0U)
...
#define C40_SECTOR_ERROR                    (528U)    /* default and error return value */
