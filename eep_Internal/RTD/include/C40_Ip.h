 ...
 *
 * @param[in] pExceptionDetailsPtr         Exception detail structure to store infomation on the exception.
 *
...
/**
 * @brief    Set synch/Async at IP layer base on the Async of HLD
 *
 * @details  This function will change C40_Ip_Async value at IP layer. Its param base on the Async of HLD.
 *           Thanks for this param, writing and erasing will operate at synch or Async mode.
 *
 * @pre     The module has to be initialized
 *
 */
