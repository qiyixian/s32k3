...
typedef struct
{
    MemAcc_AddressAreaIdType AreaId; /**< @brief Address AreaId so cluster belongs to */
    MemAcc_AddressType StartAddr;   /**< @brief Address of Fee cluster in memacc */
...
typedef struct
{
    ...
    MemAcc_AddressType               StartAddr;          /**< @brief Start address of Fee cluster in Fls address space */
